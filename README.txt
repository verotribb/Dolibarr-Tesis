                    Bitnami Dolibarr Stack 10.0.2-0
                  ==============================
...
Dolibarr is an open source, free software package for small and medium companies,
foundations or freelancers. It includes different features for enterprise
resource planning (ERP) and customer relationship management (CRM) but also
other features for different activities.

You can learn more about Dolibarr at http://www.dolibarr.org/

The Bitnami Dolibarr Stack is an installer that greatly simplifies the
installation of Dolibarr and runtime dependencies. It includes ready-to-run
versions of Apache, MySQL and PHP. Dolibarr Stack is distributed for free
...
Bitnami Dolibarr Stack ships with the following software:
...
To install Bitnami Dolibarr Stack you will need:
...
The Bitnami Dolibarr Stack is distributed as a binary executable installer.
...
bitnami-dolibarr-10.0.2-0-linux-installer.run on Linux or
bitnami-dolibarr-10.0.2-0-linux-x64-installer.run on Linux 64 bit or
bitnami-dolibarr-10.0.2-0-windows-installer.exe on Windows or
bitnami-dolibarr-10.0.2-0-osx-x86_64-installer.dmg on OS X x64 or
bitnami-dolibarr-10.0.2-0-osx-x86-installer.dmg on OS X x86.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-dolibarr-10.0.2-0-linux.run
...
Email address: Your email address. This will allow Dolibarr to send you
...
'Installation Finished' page. You can choose to launch Bitnami Dolibarr
Stack at this point. If you do so, your default web browser will open and
display the Welcome page for the Bitnami Dolibarr Stack. 

If you received an error message during installation, please refer to
the Troubleshooting section.

The rest of this guide assumes that you installed Bitnami Dolibarr
Stack in /home/user/dolibarr-10.0.2-0 on Linux or C:\Program Files\Bitnami Dolibarr Stack
on Windows or /Applications/dolibarr-10.0.2-0 and that you use port 
8080 for Apache on Linux and port 80 on Windows and 3306 for MySQL. 

5. STARTING AND STOPPING BITNAMI DOLIBARR STACK
...
On Windows, you can start and stop Bitnami Dolibarr Stack on Windows using the shortcuts created
...
installation directory:
	...
	apps/
	  dolibarr/: Dolibarr application folder
	    conf/: Dolibarr Apache configuration files
	    htdocs/: Dolibarr PHP application files
	  phpMyAdmin/: phpMyAdmin application folder

7. DEFAULT USERNAMES AND PASSWORDS

The Dolibarr administrative user and password are the ones you set at
installation time. 

MySQL admin user is called 'root', and its password is the same as the
Dolibarr administrative user password.
...
This version of the Bitnami Dolibarr stack is a preview version, and as
...
"Cannot open bitnami-dolibarr-10.0.2-0-linux.run: No application suitable for
...
/home/user/dolibarr-10.0.2-0/apache2/logs/error.log on Linux or
C:\Program Files\Bitnami Dolibarr Stack\apache2\logs\error.log on Windows or
/Applications/dolibarr-10.0.2-0/apache2/logs/error.log on OS X.
...
For any problem related to Dolibarr, please visit http://www.dolibarr.org/forum
...
Dolibarr is distributed under the GNU General Public License v3, which is
located at http://www.gnu.org/licenses/gpl.html
